package com.example.cleanarchk.presentation
...
import com.example.cleanarchk.presentation.CharacterData.FilmState
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.launch
import com.example.cleanarchk.presentation.CharacterList.CharacterListState
                ...
                async(Dispatchers.IO) {
                    try {
                        ...
                        if (!filmUrl.isNullOrBlank()) {
                            ...
                            Log.d("exception1", "Film Url is null or blank")
                        }
                    } catch (e: Exception) {
                        // Handle exceptions for individual network calls
                        Log.d("exception2", e.localizedMessage ?: "Film Details not fetched")
                    }
                }
            }.awaitAll()
            Log.e("bakk1432", filmList.toString())
